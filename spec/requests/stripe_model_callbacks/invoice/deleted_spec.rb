  ...
  describe "#execute!" do
    it "updates the given invoice" do
      expect { PublicActivity.with_tracking { mock_stripe_event("invoice.deleted") } }
        ...
        .and change(PublicActivity::Activity.where(key: "stripe_invoice.delete"), :count).by(1)
      ...
      expect(stripe_invoice).to have_attributes(
        ...
        amount_paid: Money.new(0, "DKK"),
        amount_remaining: Money.new(35_00, "DKK"),
